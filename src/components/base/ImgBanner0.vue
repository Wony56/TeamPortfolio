    ...
    <div class="banner">
      <div class="slideshow">
        <div class="slide">
          ...
          <h2 class="word word_style">122: Want to do</h2>
        </div>
      </div>
    </div>
...

{
  ...
  class Slideshow {
					constructor(el) {
						...
						this.$refs.slides = document.getElementsByClassName('.slide');
            console.log(this.$refs.slides);
						this.$refs.bgs = document.getElementsByClassName('.slide__bg');
						this.$refs.words = document.getElementsByClassName('.word');

						this.slidesTotal = this.$refs.slides.length;
						this.words = [];
				...
				const slideshow = new Slideshow(document.getElementsByClassName('.slideshow'));
