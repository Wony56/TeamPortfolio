<template>
  <div>
    <div class="grid__item">
        ...
        <img class="grid__item-img" src="http://image.chosun.com/sitedata/image/201905/10/2019051000624_0.jpg" alt="Some image" />
        <!-- <v-carousel class="notranslate" hide-delimiters>
          <v-carousel-item class="grid__item-img" v-for="(imgItem,i) in imgItems" :key="i" :src="imgItem"></v-carousel-item>
        </v-carousel> -->
			</div>
			<h3 class="grid__item-title">{{title}}</h3>
			<h4 class="grid__item-number">{{date}}</h4>
		</div>
    <div class="content">
